...
import com.artem.android.testcalendar.ui.timepicker.TimePickerFragment
import com.artem.android.testcalendar.model.Hour.Companion.stringTime
...
class TaskEditFragment: Fragment() {
    ...
    override fun onStart() {
        ...
        pickStartTimeBtn.setOnClickListener {
            ...
            val showTime =
                TimePickerFragment.newInstance(taskEditViewModel.task.dateStart.toLocalTime())
        ...
        pickFinishTimeBtn.setOnClickListener {
            ...
            val showTime =
                TimePickerFragment.newInstance(taskEditViewModel.task.dateFinish.toLocalTime())
            showTime.show(this@TaskEditFragment.childFragmentManager, DIALOG_TIME)
        }
    }
